...
print("Программа формирует случайным образом список коэффициентов (значения от 0 до 100) многочлена и записывает в файл многочлен заданной натуральной степени k.")
...
with open("d:/Мои документы/Алена/Обучение/8_4Python/Seminar4_#4/file.txt", "w") as fl:
    fl.write(PolyN)
